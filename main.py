...
ICON = pygame.image.load(os.path.join("Assets/Icon and font", "icon.png"))
...
DEATH = pygame.image.load(os.path.join("Assets/Dino", "DinoDead.png"))

SMALL_CACTUS = [pygame.image.load(os.path.join("Assets/Cactus", "SmallCactus1.png")),
                pygame.image.load(os.path.join("Assets/Cactus", "SmallCactus2.png")),
                pygame.image.load(os.path.join("Assets/Cactus", "SmallCactus3.png"))]
BIG_CACTUS = [pygame.image.load(os.path.join("Assets/Cactus", "LargeCactus1.png")),
...
def main():
    ...
    y_pos_bg = 380
    points = 0
    font = pygame.font.Font("Assets/Icon and font/EpilepsySans.ttf", 30)
    obstacles = []
    death_count = 0
...
def menu(death_count):
    ...
    while run:
        SCREEN.fill((255, 255, 255))
        font = pygame.font.Font("Assets/Icon and font/EpilepsySans.ttf", 45)
